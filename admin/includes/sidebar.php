                    ...
                    <div class="sidebar-content">
                            ...
                            <div class="content-header-section text-center align-parent sidebar-mini-hidden">
                                ...
                                <div class="content-header-item">
                                    <a class="link-effect font-w700" href="dashboard.php">
                                        ...
                                        <span class="font-size-xl text-dual-primary-dark">SHBS</span>|<span class="font-size-xl text-primary">ADMIN</span>
                                    </a>
                                </div>
                                <!-- END Logo -->
                            </div>
                        ...
                        <div class="content-side content-side-full content-side-user px-10 align-parent">
                            ...
                            <div class="sidebar-mini-visible-b align-v animated fadeIn">
                                <img class="img-avatar img-avatar32" src="assets/img/avatars/sjc logo1.jpg" alt="">
                            </div>
                            ...
                            <div class="sidebar-mini-hidden-b text-center">
                                <a class="img-link" href="dashboard.php">
                                    <img class="img-avatar" src="assets/img/avatars/sjc logo1.jpg" alt="">
                                </a>
...
{               ?>
                        ...
                        <div class="content-side content-side-full">
                            <ul class="nav-main">
                                ...
                                <li>
                                    <a class="nav-submenu" data-toggle="nav-submenu"><i class="si si-puzzle"></i><span class="sidebar-mini-hide"></span>Halls</a>
                                    <ul>
                                        <li>
                                            <a href="add-services.php">Add Halls</a>
                                        </li>
                                        <li>
                                            <a href="manage-services.php">Manage Halls</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
