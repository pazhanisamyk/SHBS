...
$query->bindParam(':serprice',$serprice,PDO::PARAM_STR);
 ...
 $query->execute();
   ...
   if ($LastInsertId>0) {
    echo '<script>alert("Halls has been added.")</script>';
...
<!doctype html>
 <html lang="en" class="no-focus"> <!--<![endif]-->
    <head>
 <title>Seminar Halls Booking System - Add Halls</title>
          ...
          <?php include_once('includes/header.php');?>
            ...
            <main id="main-container">
                ...
                <div class="content">
                    ...
                    <!-- Register Forms -->
                    <h2 class="content-heading">Add Halls</h2>
                    <div class="row">
                        <div class="col-md-12">
                            <!-- Bootstrap Register -->
                            <div class="block block-themed">
                                <div class="block-header bg-gd-emerald">
                                    <h3 class="block-title">Add Halls</h3>
                                ...
                                <div class="block-content">
                                    ...
                                    <form method="post">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-12" for="register1-email">Hall Name:</label>
                                            <div class="col-12">
                                                 <input type="text" class="form-control" name="sername" value="" required='true'>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-12" for="register1-email">Hall Description:</label>
                                            <div class="col-12">
                                                 <textarea type="text" class="form-control" name="serdes" value="" required='true'></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-12" for="register1-password">Hall Price:</label>
                                            <div class="col-12">
