...
<html lang="en">
<head>
<title>Seminar Halls Booking System|| Home Page
</title>
				...
				<div class="container">
					<div class="w3-banner-info">
						<div class="w3l-banner-text">
							<h2>SEMINAR HALLS</h2>
							<p>WE HEARTILY WELCOME YOU ALL TO SHBS</p>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="col-md-6 wthree-bottom-grid">
					<div class="w3-agileits-bottom-left">
						<div class="w3-agileits-bottom-left-text">
							...
							<p>we are always planning to conduct the events and manage it in smooth way. Your satiscification is the main moto to us. Why are you waiting for book an halls and conduct your events.</p>
						</div>
					</div>
				</div>
				<div class="col-md-6 wthree-bottom-grid">
					<div class="w3-agileits-bottom-left w3-agileits-bottom-right">
						<div class="w3-agileits-bottom-left-text">
							<h3>LET THE EXPERTS RUN YOUR EVENTS</h3>
							<p>we are having very good experts to conduct your events and manage it in smooth way. You don't worry about anything. We are here to help you.</p>
						</div>
					</div>
				</div>
			</div>
