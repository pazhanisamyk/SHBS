...
<html lang="en">
<head>
<title>Seminar Halls Booking System | Mail</title>
			...
			<div class="agile-contact-form">
				<div class="col-md-6 contact-form-left">
					<div class="w3layouts-contact-form-top">
						<h3>Get in touch</h3>
						<p>We're here to help you and answer any question that you might have.We look forward to hearing from you.Need Something? We are here to help you.For all enquires, please email us using the form.</p>
					</div>
